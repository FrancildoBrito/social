...
<div className="header">
            ...
            <div onClick={()=>fecharModalUpload()} className="close-modal-criar">X</div>
              <h2>Fazer Upload</h2>
                <form id="form-upload" onSubmit={(e)=>uploadPost(e)}>
                    ...
                    <input id="titulo-upload" type="text" placeholder="Legenda" />
      ...
      <div className="center">
          <div className="header__logo">
            <h2>Social Camocim</h2>
            <p>Deixe sua sugestão no<a 
            href="https://instagram.com/fbmultinforms?utm_medium=copy_link" target="_blank"> Insta!!</a> </p>
          </div>
          {
            (props.user)?
            <div className="header__logadoInfo">
              ...
              <a className="deslogar" onClick={(e)=>deslogar(e)}>Deslogar</a>
            </div>
            :
